...
abstract class ParameterHandler<T> {
  abstract void apply(retrofit2.RequestBuilder builder, @Nullable T value) throws IOException;

  final ParameterHandler<Iterable<T>> iterable() {
    return new ParameterHandler<Iterable<T>>() {
      @Override
      void apply(retrofit2.RequestBuilder builder, @Nullable Iterable<T> values) throws IOException {
  ...
  final ParameterHandler<Object> array() {
    return new ParameterHandler<Object>() {
      @Override
      void apply(retrofit2.RequestBuilder builder, @Nullable Object values) throws IOException {
        if (values == null) return; // Skip null values.
  ...
  static final class RelativeUrl extends ParameterHandler<Object> {
    ...
    @Override
    void apply(retrofit2.RequestBuilder builder, @Nullable Object value) {
      if (value == null) {
  ...
  static final class Header<T> extends ParameterHandler<T> {
    ...
    Header(String name, retrofit2.Converter<T, String> valueConverter) {
      this.name = Objects.requireNonNull(name, "name == null");
      this.valueConverter = valueConverter;
    }

    @Override
    void apply(retrofit2.RequestBuilder builder, @Nullable T value) throws IOException {
  ...
  static final class Path<T> extends ParameterHandler<T> {
    ...
    Path(Method method, int p, String name, retrofit2.Converter<T, String> valueConverter, boolean encoded) {
      this.method = method;
      this.p = p;
      this.name = Objects.requireNonNull(name, "name == null");
      this.valueConverter = valueConverter;
    ...
    void apply(retrofit2.RequestBuilder builder, @Nullable T value) throws IOException {
      if (value == null) {
        throw retrofit2.Utils.parameterError(
  ...
  static final class Query<T> extends ParameterHandler<T> {
    ...
    Query(String name, retrofit2.Converter<T, String> valueConverter, boolean encoded) {
      this.name = Objects.requireNonNull(name, "name == null");
      this.valueConverter = valueConverter;
      this.encoded = encoded;
    }
  ...
  static final class QueryName<T> extends ParameterHandler<T> {
    ...
    QueryName(retrofit2.Converter<T, String> nameConverter, boolean encoded) {
  ...
  static final class QueryMap<T> extends ParameterHandler<Map<String, T>> {
    ...
    QueryMap(Method method, int p, retrofit2.Converter<T, String> valueConverter, boolean encoded) {
      this.method = method;
      this.p = p;
      this.valueConverter = valueConverter;
      this.encoded = encoded;
    ...
    @Override
    void apply(retrofit2.RequestBuilder builder, @Nullable Map<String, T> value) throws IOException {
      if (value == null) {
  ...
  static final class HeaderMap<T> extends ParameterHandler<Map<String, T>> {
    ...
    HeaderMap(Method method, int p, retrofit2.Converter<T, String> valueConverter) {
      this.method = method;
      this.p = p;
      this.valueConverter = valueConverter;
    }
  ...
  static final class Headers extends ParameterHandler<okhttp3.Headers> {
    ...
    @Override
    void apply(retrofit2.RequestBuilder builder, @Nullable okhttp3.Headers headers) {
      if (headers == null) {
  ...
  static final class Field<T> extends ParameterHandler<T> {
    ...
    Field(String name, retrofit2.Converter<T, String> valueConverter, boolean encoded) {
      this.name = Objects.requireNonNull(name, "name == null");
      this.valueConverter = valueConverter;
      this.encoded = encoded;
    }
  ...
  static final class FieldMap<T> extends ParameterHandler<Map<String, T>> {
    ...
    FieldMap(Method method, int p, retrofit2.Converter<T, String> valueConverter, boolean encoded) {
      this.method = method;
      this.p = p;
      this.valueConverter = valueConverter;
      this.encoded = encoded;
  ...
  static final class Part<T> extends ParameterHandler<T> {
    ...
    Part(Method method, int p, okhttp3.Headers headers, retrofit2.Converter<T, RequestBody> converter) {
      this.method = method;
      this.p = p;
    ...
    @Override
    void apply(retrofit2.RequestBuilder builder, @Nullable T value) {
      if (value == null) return; // Skip null values.
  ...
  static final class RawPart extends ParameterHandler<MultipartBody.Part> {
    ...
    @Override
    void apply(retrofit2.RequestBuilder builder, @Nullable MultipartBody.Part value) {
  ...
  static final class PartMap<T> extends ParameterHandler<Map<String, T>> {
    ...
    PartMap(
            Method method, int p, retrofit2.Converter<T, RequestBody> valueConverter, String transferEncoding) {
      this.method = method;
      this.p = p;
      this.valueConverter = valueConverter;
