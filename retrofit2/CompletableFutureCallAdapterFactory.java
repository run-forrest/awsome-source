...
final class CompletableFutureCallAdapterFactory extends retrofit2.CallAdapter.Factory {
  ...
  retrofit2.CallAdapter<?, ?> get(
    ...
    if (getRawType(innerType) != retrofit2.Response.class) {
  ...
  private static final class BodyCallAdapter<R> implements retrofit2.CallAdapter<R, CompletableFuture<R>> {
    ...
    @Override
    public CompletableFuture<R> adapt(final retrofit2.Call<R> call) {
    ...
    private class BodyCallback implements retrofit2.Callback<R> {
      ...
      @Override
      public void onFailure(retrofit2.Call<R> call, Throwable t) {
  ...
  private static final class ResponseCallAdapter<R>
      implements CallAdapter<R, CompletableFuture<retrofit2.Response<R>>> {
    private final Type responseType;
    ...
    @Override
    public CompletableFuture<retrofit2.Response<R>> adapt(final retrofit2.Call<R> call) {
      CompletableFuture<retrofit2.Response<R>> future = new CallCancelCompletableFuture<>(call);
    ...
    private class ResponseCallback implements Callback<R> {
      private final CompletableFuture<retrofit2.Response<R>> future;

      public ResponseCallback(CompletableFuture<retrofit2.Response<R>> future) {
        this.future = future;
      }
