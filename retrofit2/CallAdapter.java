...
/**
 * Adapts a {@link retrofit2.Call} with response type {@code R} into the type of {@code T}. Instances are
 * created by {@linkplain Factory a factory} which is {@linkplain
 * retrofit2.Retrofit.Builder#addCallAdapterFactory(Factory) installed} into the {@link retrofit2.Retrofit} instance.
 */
public interface CallAdapter<R, T> {
   ...
   * retrofit2.Retrofit#create(Class) the service interface} methods.
   */
  abstract class Factory {
    ...
    protected static Type getParameterUpperBound(int index, ParameterizedType type) {
      return retrofit2.Utils.getParameterUpperBound(index, type);
    }
